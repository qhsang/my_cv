    ...
    return (
        <section className="overview">
            ...
            <p>
                ...
                - Proficient in utilizing Unity Asset Store resources to accelerate development and enhance game quality.<br />
                ...
                - Experienced in Docker, server-side development with Kotlin, good at applying OOP principles and SOLID design patterns.
            </p>
